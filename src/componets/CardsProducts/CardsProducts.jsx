    ...
    <div className='cards' style={{margin:18}}>
        <Card sx={{ maxWidth: 315, borderRadius:3, }} className='card'>
            <CardActionArea>
                ...
                <Typography variant="body1" color="text.secondary" sx={{fontFamily: "'Josefin Slab', serif", fontWeight:"800", textAlign:"center", fontSize:20, textDecoration:"none !important"}}>
